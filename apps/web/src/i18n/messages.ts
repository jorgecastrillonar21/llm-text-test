...
const en = {
  ...
  'session.situations.title': 'Going on in the world',
  'session.situations.intensity': 'intensity {n}',
  'session.situations.planned': 'expected',
  'session.situations.active': 'under way',
  'session.situations.dormant': 'quiet',
  'session.situations.resolved': 'over',
  'session.situations.cancelled': 'called off',
...
const es: Record<MessageKey, string> = {
  ...
  'session.situations.title': 'Lo que ocurre en el mundo',
  'session.situations.intensity': 'intensidad {n}',
  'session.situations.planned': 'previsto',
  'session.situations.active': 'en curso',
  'session.situations.dormant': 'en calma',
  'session.situations.resolved': 'terminado',
  'session.situations.cancelled': 'cancelado',
